...
function M.setup()
    ...
    local c = {
        ...
        c12 = "#F3F5F7", --hsl(200, 20, 96),
        wht = "#ffffff", --hsl(200, 00,100),

        red = "#91081F", --hsl(350, 90, 30)
        org = "#913608", --hsl( 20, 90, 30)
        yel = "#917A08", --hsl( 50, 90, 30)
        ylg = "#639108", --hsl( 80, 90, 30)
        grn = "#1F9108", --hsl(110, 90, 30)
        grb = "#089136", --hsl(140, 90, 30)
        blg = "#08917A", --hsl(170, 90, 30)
        blu = "#086391", --hsl(200, 90, 30)
        blp = "#081F91", --hsl(230, 90, 30)
        prb = "#360891", --hsl(260, 90, 30)
        pnk = "#7A0891", --hsl(290, 90, 30)
        prp = "#910863", --hsl(320, 90, 30)
    }
